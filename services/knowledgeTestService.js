...
const questions = [
  {
    id: 1,
    question: "What is the maximum legal driving time before a truck driver must take a mandatory rest break?",
    options: [
      "A) 6 hours",
      "B) 4.5 hours",
      "C) 8 hours",
  ...
  {
    id: 2,
    question: "When approaching a railroad crossing with no signals or barriers, what should a driver do?",
    options: [
  ...
  {
    id: 4,
    question: "When securing cargo, what is the primary purpose of load securing?",
    options: [
  ...
  {
    id: 5,
    question: "What should a driver check during a pre-trip vehicle inspection?",
    options: [
  ...
  {
    id: 6,
    question: "If a truck's brakes overheat on a long downhill descent, what is the correct technique to prevent brake fade?",
    options: [
  ...
  {
    id: 7,
    question: "What is the safe following distance a truck driver should maintain on a dry road at highway speed?",
    options: [
  ...
  {
    id: 8,
    question: "When transporting hazardous materials, which document must the driver carry at all times?",
    options: [
